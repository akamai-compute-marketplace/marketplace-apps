...
def credentials_file_path():
    """
    Returns the path to the credentials file on the remote Guacamole server.
...
def base_url(ssh_credentials) -> str:
    """
    Returns the base URL for the Guacamole app.
    ...
    Returns:
        str: The base URL of the Guacamole app.
    """
