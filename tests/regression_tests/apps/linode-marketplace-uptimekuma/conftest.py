...
def credentials_file_path():
    """
    Returns the path to the credentials file on the remote Uptime Kuma server.
...
def base_url(ssh_credentials) -> str:
    """
    Returns the base URL for the Uptime Kuma app.
    ...
    Returns:
        str: The base URL of the Uptime Kuma app.
    """
