...
def credentials_file_path():
    """
    Returns the path to the credentials file on the remote LiveSwitch server.
...
def base_url(ssh_credentials) -> str:
    """
    Returns the base URL for the LiveSwitch admin console.
    ...
    Returns:
        str: The base URL of the LiveSwitch admin console.
    """
