...
def credentials_file_path():
    """
    Returns the path to the credentials file on the remote Rocket.Chat server.
...
def base_url(ssh_credentials) -> str:
    """
    Returns the base URL for the Rocket.Chat app.
    ...
    Returns:
        str: The base URL of the Rocket.Chat app.
    """
