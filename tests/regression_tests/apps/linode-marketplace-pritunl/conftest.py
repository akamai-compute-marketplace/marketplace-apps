...
def credentials_file_path():
    """
    Returns the path to the credentials file on the remote Pritunl server.
...
def base_url(ssh_credentials) -> str:
    """
    Returns the base URL for the Pritunl admin panel.
    ...
    Returns:
        str: The base URL of the Pritunl admin panel.
    """
