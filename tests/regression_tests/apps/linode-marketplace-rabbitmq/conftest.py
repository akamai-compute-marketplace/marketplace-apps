...
def credentials_file_path():
    """
    Returns the path to the credentials file on the remote RabbitMQ server.
...
def base_url(ssh_credentials) -> str:
    """
    Returns the base URL for the RabbitMQ management UI.
    ...
    Returns:
        str: The base URL of the RabbitMQ management UI.
    """
