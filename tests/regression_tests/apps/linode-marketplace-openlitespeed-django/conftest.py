...
def credentials_file_path():
    """
    Returns the path to the credentials file on the remote OpenLiteSpeed Django server.
...
def base_url(ssh_credentials) -> str:
    """
    Returns the base URL for the Django admin panel served behind OpenLiteSpeed.
    ...
    Returns:
        str: The base URL of the Django admin panel.
    """
    host = ssh_credentials[0]
    linode_host = host.replace(".", "-")
    return f"https://{linode_host}.ip.linodeusercontent.com/admin"
