...
def credentials_file_path():
    """
    Returns the path to the credentials file on the remote HashiCorp Vault.
...
def base_url(ssh_credentials) -> str:
    """
    Constructs the base URL for the HashiCorp Vault.

    Args:
        ssh_credentials: host

    Returns:
        str: The base URL of the HashiCorp Vault.
    """
