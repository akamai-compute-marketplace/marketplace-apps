...
def credentials_file_path():
    """
    Returns the path to the credentials file on the remote WordPress server.
...
def base_url(ssh_credentials) -> str:
    """
    Returns the base URL for the WordPress app.
    ...
    Returns:
        str: The base URL of the WordPress app.
    """
