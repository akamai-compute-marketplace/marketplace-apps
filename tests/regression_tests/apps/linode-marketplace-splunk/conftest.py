...
def credentials_file_path():
    """
    Returns the path to the credentials file on the remote Splunk server.
...
def base_url(ssh_credentials) -> str:
    """
    Returns the base URL for the Splunk web UI.
    ...
    Returns:
        str: The base URL of the Splunk web UI.
    """
    host = ssh_credentials[0]
    linode_host = host.replace(".", "-")
    return f"https://{linode_host}.ip.linodeusercontent.com:8000"
