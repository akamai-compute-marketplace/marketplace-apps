...
def credentials_file_path():
    """
    Returns the path to the credentials file on the remote Pi-hole server.
...
def base_url(ssh_credentials) -> str:
    """
    Returns the base URL for the Pi-hole admin panel.
    ...
    Returns:
        str: The base URL of the Pi-hole admin panel.
    """
