...
return [
    ...
    'App' => [
        ...
        'fullBaseUrl' => env('APP_FULL_BASE_URL', 'https://{{ _domain }}'),
        // OPTIONAL
    ...
    'Email' => [
        'default' => [
            ...
            'from' => [
                env('EMAIL_DEFAULT_FROM', 'root@{{ _domain }}') => env('EMAIL_DEFAULT_FROM_NAME', 'Passbolt')
            ],
        ],
    ],
    ...
    'passbolt' => [
        ...
        'gpg' => [
            ...
            'serverKey' => [
                ...
                'fingerprint' => env('PASSBOLT_GPG_SERVER_KEY_FINGERPRINT', '{{ gpg_fingerprint }}'),
