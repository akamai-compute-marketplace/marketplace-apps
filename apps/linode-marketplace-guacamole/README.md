# Linode Apache Guacamole One-Click APP

Deploy a production-ready Apache Guacamole remote desktop gateway with built-in security and optimized performance. This setup includes Docker for containerized deployment, PostgreSQL for reliable authentication storage, and automatic SSL via Let's Encrypt. Apache Guacamole is a clientless remote desktop gateway that supports standard protocols like VNC, RDP, and SSH through a web browser without requiring plugins or client software.

## Software Included

| Software         | Version   | Description                                     |
| :---             | :----     | :---                                            |
| Apache Guacamole | 1.5.5     | Clientless remote desktop gateway               |
| PostgreSQL       | 15        | Database backend for authentication and connections |
...
Customers can choose to deploy Apache Guacamole through the Linode Marketplace or directly using API. Before using the commands below, you will need to create an [API token](https://www.linode.com/docs/products/tools/linode-api/get-started/#create-an-api-token) or configure [linode-cli](https://www.linode.com/products/cli/) on an environment.
