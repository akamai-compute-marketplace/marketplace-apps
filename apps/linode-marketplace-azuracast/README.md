# Linode AzuraCast One-Click APP

Deploy a production-ready AzuraCast web radio management suite with built-in security and optimized performance. This setup includes Docker for containerized deployment, MariaDB for reliable data storage, and automatic SSL via Let's Encrypt. AzuraCast is a self-hosted, all-in-one web radio management platform that makes it easy to manage stations, media, playlists, live DJs, analytics, and more — all from a modern web interface. The installation comes with the latest stable version pre-configured for optimal performance and security.

## Software Included

| Software      | Version   | Description                                     |
| :---          | :----     | :---                                            |
| AzuraCast     | Latest    | All-in-one web radio management suite           |
| MariaDB       | Latest    | Open-source relational database                 |
