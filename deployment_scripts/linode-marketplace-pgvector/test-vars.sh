...
if [[ -n "${POSTGRESQL_ADMIN_USER}" ]]; then
        UDF_VARS["POSTGRESQL_ADMIN_USER"]="${POSTGRESQL_ADMIN_USER}"
else
        UDF_VARS["POSTGRESQL_ADMIN_USER"]="postadmin" # default
fi

if [[ -n "${POSTGRESQL_APP_DB}" ]]; then
        UDF_VARS["POSTGRESQL_APP_DB"]="${POSTGRESQL_APP_DB}"
else
        UDF_VARS["POSTGRESQL_APP_DB"]="appname" # default
fi
