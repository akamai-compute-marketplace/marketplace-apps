...
#<UDF name="soa_email_address" label="Email address for new DNS zone" example="user@domain.tld (Requires API token)">
...
## Open WebUI
#<UDF name="openwebui_login_name" label="The initial admin login name.">
#<UDF name="openwebui_login_email" label="The email address that will used to log into Open WebUI.">
...
export MARKETPLACE_APP="apps/linode-marketplace-open-webui"
...
function udf {
  ...
  # open webui admin name
  openwebui_login_name: ${OPENWEBUI_LOGIN_NAME}

  # open webui email address
