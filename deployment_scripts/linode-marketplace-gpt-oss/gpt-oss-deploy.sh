...
#<UDF name="gpt_oss_model_size" label="GPT-OSS Model Size" oneOf="20B,120B" default="20B">
#GH_USER=""
#BRANCH=""
# git user and branch
...
export MARKETPLACE_APP="apps/linode-marketplace-gpt-oss"
...
function udf {
  ...
  # gpt-oss model size selection
  gpt_oss_model_size: ${GPT_OSS_MODEL_SIZE}
