...
#<UDF name="mc2go_port" Label="MC2GO XDCAM Transcoder API Port" example="Default: 8080" default="8080" /> 
...
export MARKETPLACE_APP="apps/linode-marketplace-mc2go-xdcam-demo"
