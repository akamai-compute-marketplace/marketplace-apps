...
if [[ -n "${DISCOURSE_ADMIN_EMAIL}" ]]; then 
	UDF_VARS["DISCOURSE_ADMIN_EMAIL"]="${DISCOURSE_ADMIN_EMAIL}"
else 
	UDF_VARS["DISCOURSE_ADMIN_EMAIL"]="admin@${DEFAULT_DNS}" 
fi

if [[ -n "${DISCOURSE_ADMIN_USERNAME}" ]]; then 
	UDF_VARS["DISCOURSE_ADMIN_USERNAME"]="${DISCOURSE_ADMIN_USERNAME}"
else 
	UDF_VARS["DISCOURSE_ADMIN_USERNAME"]="admin" 
fi
