...
#<UDF name="soa_email_address" label="Email address (for the Let's Encrypt SSL certificate)" default="">
...
export MARKETPLACE_APP="apps/linode-marketplace-hermes"
