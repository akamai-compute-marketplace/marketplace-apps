...
#github_endpoint: 'https://raw.githubusercontent.com/akamai-compute-marketplace/marketplace-apps/main/deployment_scripts/linode-marketplace-plex/plex-deploy.sh'
...
export MARKETPLACE_APP="apps/linode-marketplace-plex"
...
EOF
  ...
  if [[ -n ${PLEX_VERSION} ]]; then
    echo "plex_version: ${PLEX_VERSION}" >> ${group_vars}
  fi
}
