...
#<UDF name="soa_email_address" label="Email address used for SOA DNS record" example="user@domain.tld">
...
export MARKETPLACE_APP="apps/linode-marketplace-minecraft"
...
function udf {
  ...
  # sudo username
  username: ${USER_NAME}
  # linuxgsm game server name - hardcoded for Minecraft Java Edition
