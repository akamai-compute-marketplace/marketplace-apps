...
#<UDF name="soa_email_address" label="Email address for SSL and new DNS zone if applicable" example="user@domain.tld (Requires API token)">
...
#<UDF name="deepseek_model_size" label="DeepSeek R1 Model Size" oneOf="7B,14B,32B" default="7B">
...
export MARKETPLACE_APP="apps/linode-marketplace-deepseek"
...
function udf {
  ...
  # deepseek model size selection
  deepseek_model_size: ${DEEPSEEK_MODEL_SIZE}
